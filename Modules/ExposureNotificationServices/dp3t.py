...
class DP3TServiceKeysDownloader(exposure_notification_io.ExposureNotificationServiceKeysDownloader):
    def generate_exposure_keys_export_endpoints_with_parameters(
            self, server_endpoint_url: str, **kwargs) -> List[dict]:
        ...
        for date in dates:
            ...
            exposure_keys_export_endpoint = \
                server_endpoint_url + _dp3t_server_exposed_endpoint_path + endpoint_timestamp
