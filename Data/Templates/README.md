...
- **Applicable COVID-19 Cases** (`covid_cases`): Confirmed new COVID-19 cases in applicable regions (see notes below) estimated with a 7-day rolling average.
...
- As Radar COVID is [integrated](https://twitter.com/eu_commission/status/1318152800887558144?s=21) on the [European Federation Gateway Service (EFGS)](https://github.com/eu-federation-gateway-service/efgs-federation-gateway) project, the server may publish TEKs from multiple countries. Those EU-wide TEKs are published merged with TEKs shared from the Radar COVID app so they cannot be distinguished. To compute a valid usage ratio, we currently take in account COVID-19 cases from all the countries [integrated on the EFGS](https://ec.europa.eu/info/live-work-travel-eu/health/coronavirus-response/travel-during-coronavirus-pandemic/mobile-contact-tracing-apps-eu-member-states_en).
